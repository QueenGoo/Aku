...
TIMES="10"
CHATID="6993894531"
KEY="7192699042:AAFn74brHaTXZ12THf0ptOXBX70TdCCUhk8"
...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "\033[46m              queen Store \033[0m"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 3
clear
...
# USERNAME
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/QueenGoo/Aku/main/REGIST | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/QueenGoo/Aku/main/REGIST | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
# DETAIL ORDER
...
Exp1=$(curl https://raw.githubusercontent.com/QueenGoo/Aku/main/REGIST | grep $MYIP | awk '{print $4}')
if [[ $today < $Exp1 ]]; then
sts="${Info}"
else
sts="${Error}"
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/QueenGoo/Aku/main/"
...
restart_system() {
    USRSC=$(wget -qO- https://raw.githubusercontent.com/QueenGoo/Aku/main/REGIST | grep $ipsaya | awk '{print $2}')
    EXPSC=$(wget -qO- https://raw.githubusercontent.com/QueenGoo/Aku/main/REGIST | grep $ipsaya | awk '{print $3}')
...
"'&reply_markup={"inline_keyboard":[[{"text":"⭐ᴏʀᴅᴇʀ⭐","url":"https://t.me/QueenGoku"},{"text":"⭐ɪɴꜱᴛᴀʟʟ⭐","url":"https://wa.me/620074362"}]]}'
...
wget raw.githubusercontent.com/sanzstore21/sc/main/files/limit.sh && chmod +x limit.sh && ./limit.sh
...
function menu_noobz() {
wget https://raw.githubusercontent.com/sanzstore21/sc/main/files/noobzvpns.zip
unzip noobzvpns.zip
chmod +x noobzvpns/*
cd noobzvpns
bash install.sh
